...
@dso_apk_entries = dso_local local_unnamed_addr global [15 x %struct.DSOApkEntry] zeroinitializer, align 8
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [46 x i8] c"libMicrosoft.CognitiveServices.Speech.core.so\00", align 1
@.DSOCacheEntry.11_name = private unnamed_addr constant [61 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.audio.sys.so\00", align 1
@.DSOCacheEntry.12_name = private unnamed_addr constant [59 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.kws.ort.so\00", align 1
@.DSOCacheEntry.13_name = private unnamed_addr constant [55 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.kws.so\00", align 1
@.DSOCacheEntry.14_name = private unnamed_addr constant [54 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.lu.so\00", align 1

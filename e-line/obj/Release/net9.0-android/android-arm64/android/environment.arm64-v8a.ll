...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001a78, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001a77, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x22596c700ea5dc04, ; from name: e-line
		i64 u0xb1afcc6c04777e83, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-e-line.dll.so
		ptr null; void* handle
	}, ; 98
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x49e8ee32a2385275, ; from name: e-line.so
		i64 u0xb1afcc6c04777e83, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-e-line.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5733beff8adc3582, ; from name: aot-e-line.so
		i64 u0xb1afcc6c04777e83, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-e-line.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7a80620111d3d3ab, ; from name: libaot-e-line
		i64 u0xb1afcc6c04777e83, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-e-line.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x874efcc47e10e5e1, ; from name: aot-e-line.dll.so
		i64 u0xb1afcc6c04777e83, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-e-line.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8e85733a822645f5, ; from name: aot-e-line
		i64 u0xb1afcc6c04777e83, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-e-line.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xac05efaccc883733, ; from name: libaot-e-line.so
		i64 u0xb1afcc6c04777e83, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-e-line.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb13ac6008c50eadf, ; from name: e-line.dll.so
		i64 u0xb1afcc6c04777e83, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-e-line.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb1afcc6c04777e83, ; from name: libaot-e-line.dll.so
		i64 u0xb1afcc6c04777e83, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-e-line.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"com.companyname.eline\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [21 x i8] c"libaot-e-line.dll.so\00", align 1
